...
class GoCommandTestCase(unittest.TestCase):
    def test_tuple_returns_the_configured_command_tuple(self):
        subject = Go("mocks/triviaset.csv", Questions_Asked(), Player_Scores())
    ...
    def test_run_the_next_trivia_round_runs_a_whole_round(self):
        ...
        s = Go("mocks/triviaset.csv", Questions_Asked(), mock_player_scores)
    ...
    def test_go_command_skips_running_the_next_trivia_round_if_theres_an_error(self):
        s = Go("mocks/bad_triviaset.csv", Questions_Asked(), Player_Scores(), dont_print)
    ...
    def test_go_command_logs_if_theres_an_error(self):
        spy = Spy_Log()
        s = Go("mocks/bad_triviaset.csv", Questions_Asked(), Player_Scores(), spy.log)
    ...
    def test_go_command_skips_running_if_another_game_is_in_progress(self):
        spy = Spy_Log()
        mock_player_scores = Player_Scores()
        s = Go("mocks/triviaset.csv", Questions_Asked(), mock_player_scores, spy.log)
