...
class fake_reception:
        ...
        def decode(fake_reception, encoding):
            ...
            user_command = f':trivvy_fan!trivvy_fan@trivvy_fan.tmi.twitch.tv PRIVMSG #{chan} :!go'
            admin_command = f':{admin}!{admin}@{admin}.tmi.twitch.tv PRIVMSG #{chan} :!go'
            admin_stop_command = f':{admin}!{admin}@{admin}.tmi.twitch.tv PRIVMSG #{chan} :!stop'
            ...
            messages = [channel_message, user_message, user_answer, user_command, admin_command, admin_stop_command, self_message, ping_message, empty_message]
